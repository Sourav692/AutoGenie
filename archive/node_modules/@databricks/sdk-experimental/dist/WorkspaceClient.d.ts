import { Config, ConfigOptions } from "@databricks/sdk-experimental/src/config/Config";
import { ApiClient, ClientOptions } from "@databricks/sdk-experimental/src/api-client";
import * as agentbricks from "@databricks/sdk-experimental/src/apis/agentbricks";
import * as apps from "@databricks/sdk-experimental/src/apis/apps";
import * as catalog from "@databricks/sdk-experimental/src/apis/catalog";
import * as cleanrooms from "@databricks/sdk-experimental/src/apis/cleanrooms";
import * as compute from "@databricks/sdk-experimental/src/apis/compute";
import * as dashboards from "@databricks/sdk-experimental/src/apis/dashboards";
import * as database from "@databricks/sdk-experimental/src/apis/database";
import * as dataquality from "@databricks/sdk-experimental/src/apis/dataquality";
import * as files from "@databricks/sdk-experimental/src/apis/files";
import * as iam from "@databricks/sdk-experimental/src/apis/iam";
import * as iamv2 from "@databricks/sdk-experimental/src/apis/iamv2";
import * as jobs from "@databricks/sdk-experimental/src/apis/jobs";
import * as marketplace from "@databricks/sdk-experimental/src/apis/marketplace";
import * as ml from "@databricks/sdk-experimental/src/apis/ml";
import * as oauth2 from "@databricks/sdk-experimental/src/apis/oauth2";
import * as pipelines from "@databricks/sdk-experimental/src/apis/pipelines";
import * as qualitymonitorv2 from "@databricks/sdk-experimental/src/apis/qualitymonitorv2";
import * as serving from "@databricks/sdk-experimental/src/apis/serving";
import * as settings from "@databricks/sdk-experimental/src/apis/settings";
import * as settingsv2 from "@databricks/sdk-experimental/src/apis/settingsv2";
import * as sharing from "@databricks/sdk-experimental/src/apis/sharing";
import * as sql from "@databricks/sdk-experimental/src/apis/sql";
import * as tags from "@databricks/sdk-experimental/src/apis/tags";
import * as vectorsearch from "@databricks/sdk-experimental/src/apis/vectorsearch";
import * as workspace from "@databricks/sdk-experimental/src/apis/workspace";
import { ClustersExt } from "@databricks/sdk-experimental/src/mixins/compute";
export declare class WorkspaceClient {
     ...
     */
    readonly accessControl: iam.AccessControlService;
    /**
     ...
     * product.
     */
    readonly agentBricks: agentbricks.AgentBricksService;
    /**
     ...
     */
    readonly alertsLegacy: sql.AlertsLegacyService;
    /**
     * New version of SQL Alerts
     */
    readonly alertsV2: sql.AlertsV2Service;
    /**
     ...
     * single sign-on.
     */
    readonly apps: apps.AppsService;
    /**
     * Apps Settings manage the settings for the Apps service on a customer's
     * Databricks instance.
     */
    readonly appsSettings: apps.AppsSettingsService;
    /**
     ...
     */
    readonly artifactAllowlists: catalog.ArtifactAllowlistsService;
    /**
     ...
     */
    readonly cleanRoomAssetRevisions: cleanrooms.CleanRoomAssetRevisionsService;
    /**
     * Clean room assets are data and code objects — Tables, volumes, and notebooks
     * that are shared with the clean room.
     */
    readonly cleanRoomAssets: cleanrooms.CleanRoomAssetsService;
    /**
     ...
     * room.
     */
    readonly cleanRoomAutoApprovalRules: cleanrooms.CleanRoomAutoApprovalRulesService;
    /**
     * Clean room task runs are the executions of notebooks in a clean room.
     */
    readonly cleanRoomTaskRuns: cleanrooms.CleanRoomTaskRunsService;
    /**
     ...
     */
    readonly cleanRooms: cleanrooms.CleanRoomsService;
    /**
     ...
     */
    readonly consumerFulfillments: marketplace.ConsumerFulfillmentsService;
    /**
     * Installations are entities that allow consumers to interact with Databricks
     * Marketplace listings.
     */
    readonly consumerInstallations: marketplace.ConsumerInstallationsService;
    /**
     * Listings are the core entities in the Marketplace. They represent the products
     * that are available for consumption.
     */
    readonly consumerListings: marketplace.ConsumerListingsService;
    /**
     * Personalization Requests allow customers to interact with the individualized
     * Marketplace listing flow.
     */
    readonly consumerPersonalizationRequests: marketplace.ConsumerPersonalizationRequestsService;
    /**
     * Providers are the entities that publish listings to the Marketplace.
     */
    readonly consumerProviders: marketplace.ConsumerProvidersService;
    /**
     ...
     */
    readonly credentials: catalog.CredentialsService;
    /**
     ...
     */
    readonly credentialsManager: settings.CredentialsManagerService;
    /**
     ...
     * change over time.
     */
    readonly dashboardWidgets: sql.DashboardWidgetsService;
    /**
     ...
     * and `table`)
     */
    readonly dataQuality: dataquality.DataQualityService;
    /**
     ...
     */
    readonly database: database.DatabaseService;
    /**
     ...
     */
    readonly entityTagAssignments: catalog.EntityTagAssignmentsService;
    /**
     ...
     */
    readonly externalLineage: catalog.ExternalLineageService;
    /**
     ...
     * objects.
     */
    readonly externalMetadata: catalog.ExternalMetadataService;
    /**
     * [description]
     */
    readonly featureEngineering: ml.FeatureEngineeringService;
    /**
     ...
     */
    readonly featureStore: ml.FeatureStoreService;
    /**
     * The Files API is a standard HTTP API that allows you to read, write, list, and
     * delete files and directories by referring to their URI. The API makes working
     * with file content as raw bytes easier and more efficient.
     *
     ...
     * `enable_experimental_files_api_client = True` in your configuration profile or
     ...
     */
    readonly genie: dashboards.GenieService;
    /**
     ...
     */
    readonly groupsV2: iam.GroupsV2Service;
    /**
     ...
     */
    readonly lakeview: dashboards.LakeviewService;
    /**
     * Token-based Lakeview APIs for embedding dashboards in external applications.
     */
    readonly lakeviewEmbedded: dashboards.LakeviewEmbeddedService;
    /**
     ...
     */
    readonly materializedFeatures: ml.MaterializedFeaturesService;
    /**
     ...
     */
    readonly modelVersions: catalog.ModelVersionsService;
    /**
     ...
     * destinations.
     */
    readonly notificationDestinations: settings.NotificationDestinationsService;
    /**
     * Online tables provide lower latency and higher QPS access to data from Delta
     * tables.
     */
    readonly onlineTables: catalog.OnlineTablesService;
    /**
     * APIs for migrating acl permissions, used only by the ucx tool:
     * https://github.com/databrickslabs/ucx
     */
    readonly permissionMigration: iam.PermissionMigrationService;
    /**
     ...
     * policies.
     */
    readonly policies: catalog.PoliciesService;
    /**
     ...
     */
    readonly policyComplianceForClusters: compute.PolicyComplianceForClustersService;
    /**
     ...
     */
    readonly policyComplianceForJobs: jobs.PolicyComplianceForJobsService;
    /**
     ...
     */
    readonly providerExchangeFilters: marketplace.ProviderExchangeFiltersService;
    /**
     * Marketplace exchanges allow providers to share their listings with a curated
     * set of customers.
     */
    readonly providerExchanges: marketplace.ProviderExchangesService;
    /**
     * Marketplace offers a set of file APIs for various purposes such as preview
     * notebooks and provider icons.
     */
    readonly providerFiles: marketplace.ProviderFilesService;
    /**
     * Listings are the core entities in the Marketplace. They represent the products
     * that are available for consumption.
     */
    readonly providerListings: marketplace.ProviderListingsService;
    /**
     * Personalization requests are an alternate to instantly available listings.
     * Control the lifecycle of personalized solutions.
     */
    readonly providerPersonalizationRequests: marketplace.ProviderPersonalizationRequestsService;
    /**
     * Manage templated analytics solution for providers.
     */
    readonly providerProviderAnalyticsDashboards: marketplace.ProviderProviderAnalyticsDashboardsService;
    /**
     * Providers are entities that manage assets in Marketplace.
     */
    readonly providerProviders: marketplace.ProviderProvidersService;
    /**
     ...
     */
    readonly qualityMonitorV2: qualitymonitorv2.QualityMonitorV2Service;
    /**
     ...
     * **USE_CATALOG**).
     */
    readonly qualityMonitors: catalog.QualityMonitorsService;
    /**
     ...
     * [Learn more]: https://docs.databricks.com/en/sql/dbsql-api-latest.html
     */
    readonly queriesLegacy: sql.QueriesLegacyService;
    /**
     ...
     */
    readonly queryVisualizations: sql.QueryVisualizationsService;
    /**
     * This is an evolving API that facilitates the addition and removal of
     ...
     * [Learn more]: https://docs.databricks.com/en/sql/dbsql-api-latest.html
     */
    readonly queryVisualizationsLegacy: sql.QueryVisualizationsLegacyService;
    /**
     ...
     */
    readonly recipientFederationPolicies: sharing.RecipientFederationPoliciesService;
    /**
     ...
     */
    readonly redashConfig: sql.RedashConfigService;
    /**
     * Databricks provides a hosted version of MLflow Model Registry in Unity
     * Catalog. Models in Unity Catalog provide centralized access control, auditing,
     * lineage, and discovery of ML models across Databricks workspaces.
     ...
     * type.
     */
    readonly registeredModels: catalog.RegisteredModelsService;
    /**
     ...
     */
    readonly resourceQuotas: catalog.ResourceQuotasService;
    /**
     ...
     */
    readonly rfa: catalog.RfaService;
    /**
     ...
     */
    readonly servicePrincipalSecretsProxy: oauth2.ServicePrincipalSecretsProxyService;
    /**
     ...
     */
    readonly servicePrincipalsV2: iam.ServicePrincipalsV2Service;
    /**
     ...
     */
    readonly settings: settings.SettingsService;
    /**
     ...
     */
    readonly tagPolicies: tags.TagPoliciesService;
    /**
     ...
     */
    readonly temporaryPathCredentials: catalog.TemporaryPathCredentialsService;
    /**
     ...
     */
    readonly temporaryTableCredentials: catalog.TemporaryTableCredentialsService;
    /**
     ...
     */
    readonly usersV2: iam.UsersV2Service;
    /**
     * **Endpoint**: Represents the compute resources to host vector search indexes.
     */
    readonly vectorSearchEndpoints: vectorsearch.VectorSearchEndpointsService;
    /**
     * **Index**: An efficient representation of your embedding vectors that supports
     ...
     */
    readonly vectorSearchIndexes: vectorsearch.VectorSearchIndexesService;
    /**
