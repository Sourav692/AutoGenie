...
import * as files from "@databricks/sdk-experimental/src/apis/files/model";
...
export declare class DbfsService {
     ...
     */
    addBlock(request: files.AddBlock, context?: Context): Promise<EmptyResponse>;
    private _close;
    /**
     * Closes the stream specified by the input handle. If the handle does not
     * exist, this call throws an exception with ``RESOURCE_DOES_NOT_EXIST``.
     */
    close(request: files.Close, context?: Context): Promise<EmptyResponse>;
    private _create;
    /**
     ...
     */
    create(request: files.Create, context?: Context): Promise<files.CreateResponse>;
    private _delete;
    /**
     ...
     */
    delete(request: files.Delete, context?: Context): Promise<EmptyResponse>;
    private _getStatus;
    /**
     ...
     * `RESOURCE_DOES_NOT_EXIST`.
     */
    getStatus(request: files.GetStatusRequest, context?: Context): Promise<files.FileInfo>;
    private _list;
    /**
     ...
     */
    list(request: files.ListDbfsRequest, context?: Context): AsyncIterable<files.FileInfo>;
    private _mkdirs;
    /**
     ...
     */
    mkdirs(request: files.MkDirs, context?: Context): Promise<EmptyResponse>;
    private _move;
    /**
     ...
     * files.
     */
    move(request: files.Move, context?: Context): Promise<EmptyResponse>;
    private _put;
    /**
     ...
     */
    put(request: files.Put, context?: Context): Promise<EmptyResponse>;
    private _read;
    /**
     ...
     */
    read(request: files.ReadDbfsRequest, context?: Context): Promise<files.ReadResponse>;
}
export declare class FilesRetriableError extends ApiRetriableError {
    constructor(method: string, message?: string);
}
export declare class FilesError extends ApiError {
    constructor(method: string, message?: string);
}
/**
...
export declare class FilesService {
     ...
     * -p`). If called on an existing directory, returns a success response; this
     * method is idempotent (it will succeed if the directory already exists).
     */
    createDirectory(request: files.CreateDirectoryRequest, context?: Context): Promise<EmptyResponse>;
    private _delete;
    /**
     * Deletes a file. If the request is successful, there is no response body.
     */
    delete(request: files.DeleteFileRequest, context?: Context): Promise<EmptyResponse>;
     ...
     */
    deleteDirectory(request: files.DeleteDirectoryRequest, context?: Context): Promise<EmptyResponse>;
    private _download;
    /**
     ...
     */
    download(request: files.DownloadRequest, context?: Context): Promise<files.DownloadResponse>;
    private _getDirectoryMetadata;
    /**
     ...
     */
    getDirectoryMetadata(request: files.GetDirectoryMetadataRequest, context?: Context): Promise<EmptyResponse>;
    private _getMetadata;
    /**
     * Get the metadata of a file. The response HTTP headers contain the
     * metadata. There is no response body.
     */
    getMetadata(request: files.GetMetadataRequest, context?: Context): Promise<files.GetMetadataResponse>;
    private _listDirectoryContents;
    /**
     * Returns the contents of a directory. If there is no directory at the
     * specified path, the API returns a HTTP 404 error.
     */
    listDirectoryContents(request: files.ListDirectoryContentsRequest, context?: Context): AsyncIterable<files.DirectoryEntry>;
    private _upload;
    /**
     ...
     */
    upload(request: files.UploadRequest, context?: Context): Promise<EmptyResponse>;
}
