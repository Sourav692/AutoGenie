...
import * as workspace from "@databricks/sdk-experimental/src/apis/workspace/model";
...
export declare class GitCredentialsService {
     ...
     */
    create(request: workspace.CreateCredentialsRequest, context?: Context): Promise<workspace.CreateCredentialsResponse>;
    private _delete;
    /**
     * Deletes the specified Git credential.
     */
    delete(request: workspace.DeleteCredentialsRequest, context?: Context): Promise<EmptyResponse>;
    private _get;
    /**
     * Gets the Git credential with the specified credential ID.
     */
    get(request: workspace.GetCredentialsRequest, context?: Context): Promise<workspace.GetCredentialsResponse>;
    private _list;
    /**
     * Lists the calling user's Git credentials. One credential per user is
     * supported.
     */
    list(context?: Context): AsyncIterable<workspace.CredentialInfo>;
    private _update;
    /**
     * Updates the specified Git credential.
     */
    update(request: workspace.UpdateCredentialsRequest, context?: Context): Promise<EmptyResponse>;
}
...
export declare class ReposService {
     ...
     */
    create(request: workspace.CreateRepoRequest, context?: Context): Promise<workspace.CreateRepoResponse>;
    private _delete;
    /**
     * Deletes the specified repo.
     */
    delete(request: workspace.DeleteRepoRequest, context?: Context): Promise<EmptyResponse>;
    private _get;
    /**
     * Returns the repo with the given repo ID.
     */
    get(request: workspace.GetRepoRequest, context?: Context): Promise<workspace.GetRepoResponse>;
    private _getPermissionLevels;
    /**
     * Gets the permission levels that a user can have on an object.
     */
    getPermissionLevels(request: workspace.GetRepoPermissionLevelsRequest, context?: Context): Promise<workspace.GetRepoPermissionLevelsResponse>;
    private _getPermissions;
    /**
     * Gets the permissions of a repo. Repos can inherit permissions from their
     * root object.
     */
    getPermissions(request: workspace.GetRepoPermissionsRequest, context?: Context): Promise<workspace.RepoPermissions>;
    private _list;
    /**
     * Returns repos that the calling user has Manage permissions on. Use
     * `next_page_token` to iterate through additional pages.
     */
    list(request: workspace.ListReposRequest, context?: Context): AsyncIterable<workspace.RepoInfo>;
     ...
     */
    setPermissions(request: workspace.RepoPermissionsRequest, context?: Context): Promise<workspace.RepoPermissions>;
    private _update;
    /**
     * Updates the repo to a different branch or tag, or updates the repo to the
     * latest commit on the same branch.
     */
    update(request: workspace.UpdateRepoRequest, context?: Context): Promise<EmptyResponse>;
    private _updatePermissions;
    /**
     * Updates the permissions on a repo. Repos can inherit permissions from
     * their root object.
     */
    updatePermissions(request: workspace.RepoPermissionsRequest, context?: Context): Promise<workspace.RepoPermissions>;
}
...
export declare class SecretsService {
     ...
     * "users" "scope_backend_type": "databricks|azure_keyvault", # below is only
     * required if scope type is azure_keyvault "backend_azure_keyvault": {
     * "resource_id":
     ...
     * the workspace is exceeded. Throws ``INVALID_PARAMETER_VALUE`` if the scope
     * name is invalid. Throws ``BAD_REQUEST`` if request violated constraints.
     * Throws ``CUSTOMER_UNAUTHORIZED`` if normal user attempts to create a scope
     * with name reserved for databricks internal usage. Throws
     * ``UNAUTHENTICATED`` if unable to verify user access permission on Azure
     * KeyVault
     */
    createScope(request: workspace.CreateScope, context?: Context): Promise<EmptyResponse>;
    private _deleteAcl;
    /**
     ...
     */
    deleteAcl(request: workspace.DeleteAcl, context?: Context): Promise<EmptyResponse>;
     ...
     */
    deleteScope(request: workspace.DeleteScope, context?: Context): Promise<EmptyResponse>;
     ...
     * backed scope.
     */
    deleteSecret(request: workspace.DeleteSecret, context?: Context): Promise<EmptyResponse>;
    private _getAcl;
    /**
     ...
     */
    getAcl(request: workspace.GetAclRequest, context?: Context): Promise<workspace.AclItem>;
    private _getSecret;
    /**
     ...
     * bytes is determined by the caller in DBUtils and the type the data is
     * decoded into.
     *
     ...
     * 4xx error
     */
    getSecret(request: workspace.GetSecretRequest, context?: Context): Promise<workspace.GetSecretResponse>;
    private _listAcls;
    /**
     ...
     * API call.
     */
    listAcls(request: workspace.ListAclsRequest, context?: Context): AsyncIterable<workspace.AclItem>;
    private _listScopes;
    /**
     ...
     * this API call.
     */
    listScopes(context?: Context): AsyncIterable<workspace.SecretScope>;
     ...
     * API call.
     */
    listSecrets(request: workspace.ListSecretsRequest, context?: Context): AsyncIterable<workspace.SecretMetadata>;
    private _putAcl;
    /**
     ...
     * the most powerful permission available to them, and permissions are
     * ordered as follows:
     *
     ...
     */
    putAcl(request: workspace.PutAcl, context?: Context): Promise<EmptyResponse>;
    private _putSecret;
    /**
     ...
     * encryption settings before storing it. You must have ``WRITE`` or
     * ``MANAGE`` permission on the secret scope.
     *
     ...
     * to make this API call. Throws ``MALFORMED_REQUEST`` if request is
     * incorrectly formatted or conflicting. Throws ``BAD_REQUEST`` if request is
     * made against Azure KeyVault backed scope.
     */
    putSecret(request: workspace.PutSecret, context?: Context): Promise<EmptyResponse>;
}
...
export declare class WorkspaceService {
     ...
     * not atomic.
     */
    delete(request: workspace.Delete, context?: Context): Promise<EmptyResponse>;
    private _export;
    /**
     ...
     * exporting a library.
     */
    export(request: workspace.ExportRequest, context?: Context): Promise<workspace.ExportResponse>;
    private _getPermissionLevels;
    /**
     * Gets the permission levels that a user can have on an object.
     */
    getPermissionLevels(request: workspace.GetWorkspaceObjectPermissionLevelsRequest, context?: Context): Promise<workspace.GetWorkspaceObjectPermissionLevelsResponse>;
    private _getPermissions;
    /**
     ...
     */
    getPermissions(request: workspace.GetWorkspaceObjectPermissionsRequest, context?: Context): Promise<workspace.WorkspaceObjectPermissions>;
    private _getStatus;
    /**
     * Gets the status of an object or a directory. If `path` does not exist,
     * this call returns an error `RESOURCE_DOES_NOT_EXIST`.
     */
    getStatus(request: workspace.GetStatusRequest, context?: Context): Promise<workspace.ObjectInfo>;
    private _import;
    /**
     ...
     * To import a directory, you can use either the `DBC` format or the `SOURCE`
     * format with the `language` field unset. To import a single file as
     * `SOURCE`, you must set the `language` field. Zip files within directories
     * are not supported.
     */
    import(request: workspace.Import, context?: Context): Promise<EmptyResponse>;
    private _list;
    /**
     ...
     * `RESOURCE_DOES_NOT_EXIST`.
     */
    list(request: workspace.ListWorkspaceRequest, context?: Context): AsyncIterable<workspace.ObjectInfo>;
    private _mkdirs;
    /**
     ...
     */
    mkdirs(request: workspace.Mkdirs, context?: Context): Promise<EmptyResponse>;
    private _setPermissions;
    /**
     * Sets permissions on an object, replacing existing permissions if they
     * exist. Deletes all direct permissions if none are specified. Objects can
     ...
     */
    setPermissions(request: workspace.WorkspaceObjectPermissionsRequest, context?: Context): Promise<workspace.WorkspaceObjectPermissions>;
    private _updatePermissions;
    /**
     * Updates the permissions on a workspace object. Workspace objects can
     * inherit permissions from their parent objects or root object.
     */
    updatePermissions(request: workspace.WorkspaceObjectPermissionsRequest, context?: Context): Promise<workspace.WorkspaceObjectPermissions>;
}
