...
interface AuthorizationDetails {
     ...
     */
    grant_rules?: Array<AuthorizationDetailsGrantRule>;
    /**
...
interface AuthorizationDetailsGrantRule {
    /**
...
type DashboardView = "DASHBOARD_VIEW_BASIC";
...
interface GenieAttachment {
     ...
     */
    suggested_questions?: GenieSuggestedQuestionsAttachment;
    /**
 ...
 */
type GenieFeedbackRating = "NEGATIVE" | "NONE" | "POSITIVE";
...
export interface GenieListConversationsResponse {
     ...
     */
    conversations?: Array<GenieConversationSummary>;
    /**
     * Token to get the next page of results
     */
    next_page_token?: string;
...
export interface GenieMessage {
     ...
     * context step to determine relevant context. * `ASKING_AI`: Waiting for the
     * LLM to respond to the user's question. * `PENDING_WAREHOUSE`: Waiting for
     * warehouse before the SQL query can start executing. * `EXECUTING_QUERY`:
     ...
     * `error` field. * `COMPLETED`: Message processing is completed. Results are
     * in the `attachments` field. Get the SQL query result by calling
     * [getMessageAttachmentQueryResult](:method:genie/getMessageAttachmentQueryResult)
...
interface GenieQueryAttachment {
     ...
     */
    last_updated_timestamp?: number;
    parameters?: Array<QueryAttachmentParameter>;
    /**
     ...
     */
    query_result_metadata?: GenieResultMetadata;
    /**
 ...
 * Follow-up questions suggested by Genie
 */
interface GenieSuggestedQuestionsAttachment {
    /**
...
export interface GetPublishedDashboardTokenInfoResponse {
     ...
     */
    authorization_details?: Array<AuthorizationDetails>;
    /**
...
type SchedulePauseStatus = "PAUSED" | "UNPAUSED";
...
interface SubscriptionSubscriberDestination {
    /**
     * The canonical identifier of the destination to receive email notification.
     */
    destination_id: string;
}
interface SubscriptionSubscriberUser {
    /**
 ...
 */
type TextAttachmentPurpose = "FOLLOW_UP_QUESTION";
