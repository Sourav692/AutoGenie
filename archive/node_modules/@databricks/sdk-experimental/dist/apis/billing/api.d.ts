...
import * as billing from "@databricks/sdk-experimental/src/apis/billing/model";
...
export declare class BillableUsageService {
     ...
     */
    download(request: billing.DownloadRequest, context?: Context): Promise<billing.DownloadResponse>;
}
export declare class BudgetPolicyRetriableError extends ApiRetriableError {
    constructor(method: string, message?: string);
}
export declare class BudgetPolicyError extends ApiError {
    constructor(method: string, message?: string);
}
/**
 * A service serves REST API about Budget policies
 */
export declare class BudgetPolicyService {
    readonly client: ApiClient;
    constructor(client: ApiClient);
    private _create;
    /**
     ...
     */
    create(request: billing.CreateBudgetPolicyRequest, context?: Context): Promise<billing.BudgetPolicy>;
    private _delete;
    /**
     * Deletes a policy
     */
    delete(request: billing.DeleteBudgetPolicyRequest, context?: Context): Promise<EmptyResponse>;
    private _get;
    /**
     * Retrieves a policy by it's ID.
     */
    get(request: billing.GetBudgetPolicyRequest, context?: Context): Promise<billing.BudgetPolicy>;
    private _list;
    /**
     * Lists all policies. Policies are returned in the alphabetically ascending
     * order of their names.
     */
    list(request: billing.ListBudgetPoliciesRequest, context?: Context): AsyncIterable<billing.BudgetPolicy>;
    private _update;
    /**
     * Updates a policy
     */
    update(request: billing.UpdateBudgetPolicyRequest, context?: Context): Promise<billing.BudgetPolicy>;
}
...
export declare class BudgetsService {
     ...
     */
    create(request: billing.CreateBudgetConfigurationRequest, context?: Context): Promise<billing.CreateBudgetConfigurationResponse>;
    private _delete;
    /**
     ...
     */
    delete(request: billing.DeleteBudgetConfigurationRequest, context?: Context): Promise<EmptyResponse>;
    private _get;
    /**
     * Gets a budget configuration for an account. Both account and budget
     * configuration are specified by ID.
     */
    get(request: billing.GetBudgetConfigurationRequest, context?: Context): Promise<billing.GetBudgetConfigurationResponse>;
    private _list;
    /**
     * Gets all budgets associated with this account.
     */
    list(request: billing.ListBudgetConfigurationsRequest, context?: Context): AsyncIterable<billing.BudgetConfiguration>;
    private _update;
    /**
     * Updates a budget configuration for an account. Both account and budget
     * configuration are specified by ID.
     */
    update(request: billing.UpdateBudgetConfigurationRequest, context?: Context): Promise<billing.UpdateBudgetConfigurationResponse>;
}
...
export declare class LogDeliveryService {
     ...
     */
    create(request: billing.WrappedCreateLogDeliveryConfiguration, context?: Context): Promise<billing.WrappedLogDeliveryConfiguration>;
    private _get;
    /**
     * Gets a Databricks log delivery configuration object for an account, both
     * specified by ID.
     */
    get(request: billing.GetLogDeliveryRequest, context?: Context): Promise<billing.GetLogDeliveryConfigurationResponse>;
    private _list;
    /**
     * Gets all Databricks log delivery configurations associated with an account
     * specified by ID.
     */
    list(request: billing.ListLogDeliveryRequest, context?: Context): AsyncIterable<billing.LogDeliveryConfiguration>;
     ...
     */
    patchStatus(request: billing.UpdateLogDeliveryConfigurationStatusRequest, context?: Context): Promise<EmptyResponse>;
}
export declare class UsageDashboardsRetriableError extends ApiRetriableError {
    constructor(method: string, message?: string);
}
export declare class UsageDashboardsError extends ApiError {
    constructor(method: string, message?: string);
}
/**
 ...
 */
export declare class UsageDashboardsService {
    readonly client: ApiClient;
    constructor(client: ApiClient);
    private _create;
    /**
     ...
     * dashboard type.
     */
    create(request: billing.CreateBillingUsageDashboardRequest, context?: Context): Promise<billing.CreateBillingUsageDashboardResponse>;
    private _get;
    /**
     * Get a usage dashboard specified by workspaceId, accountId, and dashboard
     * type.
     */
    get(request: billing.GetBillingUsageDashboardRequest, context?: Context): Promise<billing.GetBillingUsageDashboardResponse>;
}
