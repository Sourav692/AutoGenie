...
export interface AlertConfiguration {
     ...
     */
    quantity_type?: AlertConfigurationQuantityType;
    /**
     * The time window of usage data for the budget.
     */
    time_period?: AlertConfigurationTimePeriod;
    /**
     * The evaluation method to determine when this budget alert is in a
     * triggered state.
     */
    trigger_type?: AlertConfigurationTriggerType;
}
export type AlertConfigurationQuantityType = "LIST_PRICE_DOLLARS_USD";
export type AlertConfigurationTimePeriod = "MONTH";
export type AlertConfigurationTriggerType = "CUMULATIVE_SPENDING_EXCEEDED";
export interface BudgetConfiguration {
     ...
     */
    alert_configurations?: Array<AlertConfiguration>;
    /**
...
export interface BudgetConfigurationFilter {
     ...
     */
    tags?: Array<BudgetConfigurationFilterTagClause>;
    /**
     * If provided, usage must match with the provided Databricks workspace IDs.
     */
    workspace_id?: BudgetConfigurationFilterWorkspaceIdClause;
}
export interface BudgetConfigurationFilterClause {
    operator?: BudgetConfigurationFilterOperator;
    values?: Array<string>;
}
export type BudgetConfigurationFilterOperator = "IN";
export interface BudgetConfigurationFilterTagClause {
    key?: string;
    value?: BudgetConfigurationFilterClause;
}
export interface BudgetConfigurationFilterWorkspaceIdClause {
    operator?: BudgetConfigurationFilterOperator;
    values?: Array<number>;
}
/**
...
export interface BudgetPolicy {
     ...
     * in the account.
     */
    binding_workspace_ids?: Array<number>;
    /**
     * A list of tags defined by the customer. At most 20 entries are allowed per
     * policy.
     */
    custom_tags?: Array<compute.CustomPolicyTag>;
    /**
...
export interface CreateBillingUsageDashboardRequest {
     ...
     */
    dashboard_type?: UsageDashboardType;
    /**
...
export interface CreateBudgetConfigurationBudget {
     ...
     * have exactly one alert configuration.
     */
    alert_configurations?: Array<CreateBudgetConfigurationBudgetAlertConfigurations>;
    /**
     * Human-readable name of budget configuration. Max Length: 128
     */
    display_name?: string;
...
export interface CreateBudgetConfigurationBudgetAlertConfigurations {
     ...
     * enters a triggered state.
     */
    action_configurations?: Array<CreateBudgetConfigurationBudgetActionConfigurations>;
    /**
     * The threshold for the budget alert to determine if it is in a triggered
     * state. The number is evaluated based on `quantity_type`.
     */
 ...
 * the configuration has been disabled since the release of this feature or there
 * are no workspaces in the account.
 */
export type DeliveryStatus = "CREATED" | "NOT_FOUND" | "SUCCEEDED" | "SYSTEM_FAILURE" | "USER_FAILURE";
...
/**
 * Structured representation of a filter to be applied to a list of policies. All
 * specified filters will be applied in conjunction.
 */
...
export interface ListBudgetConfigurationsResponse {
    budgets?: Array<BudgetConfiguration>;
    /**
...
export type SortSpecField = "POLICY_NAME";
...
export type UsageDashboardType = "USAGE_DASHBOARD_TYPE_GLOBAL" | "USAGE_DASHBOARD_TYPE_WORKSPACE";
/**
