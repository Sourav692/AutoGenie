...
import * as compute from "@databricks/sdk-experimental/src/apis/compute/model";
...
export declare class ClusterPoliciesService {
     ...
     */
    create(request: compute.CreatePolicy, context?: Context): Promise<compute.CreatePolicyResponse>;
    private _delete;
    /**
     * Delete a policy for a cluster. Clusters governed by this policy can still
     * run, but cannot be edited.
     */
    delete(request: compute.DeletePolicy, context?: Context): Promise<EmptyResponse>;
    private _edit;
    /**
     * Update an existing policy for cluster. This operation may make some
     * clusters governed by the previous policy invalid.
     */
    edit(request: compute.EditPolicy, context?: Context): Promise<EmptyResponse>;
    private _get;
    /**
     * Get a cluster policy entity. Creation and editing is available to admins
     * only.
     */
    get(request: compute.GetClusterPolicyRequest, context?: Context): Promise<compute.Policy>;
    private _getPermissionLevels;
    /**
     * Gets the permission levels that a user can have on an object.
     */
    getPermissionLevels(request: compute.GetClusterPolicyPermissionLevelsRequest, context?: Context): Promise<compute.GetClusterPolicyPermissionLevelsResponse>;
    private _getPermissions;
    /**
     * Gets the permissions of a cluster policy. Cluster policies can inherit
     * permissions from their root object.
     */
    getPermissions(request: compute.GetClusterPolicyPermissionsRequest, context?: Context): Promise<compute.ClusterPolicyPermissions>;
    private _list;
    /**
     * Returns a list of policies accessible by the requesting user.
     */
    list(request: compute.ListClusterPoliciesRequest, context?: Context): AsyncIterable<compute.Policy>;
     ...
     */
    setPermissions(request: compute.ClusterPolicyPermissionsRequest, context?: Context): Promise<compute.ClusterPolicyPermissions>;
    private _updatePermissions;
    /**
     * Updates the permissions on a cluster policy. Cluster policies can inherit
     * permissions from their root object.
     */
    updatePermissions(request: compute.ClusterPolicyPermissionsRequest, context?: Context): Promise<compute.ClusterPolicyPermissions>;
}
...
export declare class ClustersService {
    ...
    /**
     * Change the owner of the cluster. You must be an admin and the cluster must
     * be terminated to perform this operation. The service principal application
     * ID can be supplied as an argument to `owner_username`.
     */
    changeOwner(request: compute.ChangeClusterOwner, context?: Context): Promise<EmptyResponse>;
    private _create;
    /**
     ...
     * Databricks recommends filling out the [create compute UI] and then copying
     * the generated JSON definition from the UI.
     *
     * [create compute UI]: https://docs.databricks.com/compute/configure.html
     */
    create(createCluster: compute.CreateCluster, context?: Context): Promise<Waiter<compute.CreateClusterResponse, compute.ClusterDetails>>;
    private _delete;
    /**
     ...
     */
    delete(deleteCluster: compute.DeleteCluster, context?: Context): Promise<Waiter<EmptyResponse, compute.ClusterDetails>>;
    private _edit;
    /**
     ...
     */
    edit(editCluster: compute.EditCluster, context?: Context): Promise<Waiter<EmptyResponse, compute.ClusterDetails>>;
    private _events;
    /**
     ...
     */
    events(request: compute.GetEvents, context?: Context): AsyncIterable<compute.ClusterEvent>;
    private _get;
    /**
     ...
     * terminated.
     */
    get(request: compute.GetClusterRequest, context?: Context): Promise<compute.ClusterDetails>;
    private _getPermissionLevels;
    /**
     * Gets the permission levels that a user can have on an object.
     */
    getPermissionLevels(request: compute.GetClusterPermissionLevelsRequest, context?: Context): Promise<compute.GetClusterPermissionLevelsResponse>;
    private _getPermissions;
    /**
     * Gets the permissions of a cluster. Clusters can inherit permissions from
     * their root object.
     */
    getPermissions(request: compute.GetClusterPermissionsRequest, context?: Context): Promise<compute.ClusterPermissions>;
    private _list;
    /**
     ...
     */
    list(request: compute.ListClustersRequest, context?: Context): AsyncIterable<compute.ClusterDetails>;
    private _listNodeTypes;
    /**
     * Returns a list of supported Spark node types. These node types can be used
     * to launch a cluster.
     */
    listNodeTypes(context?: Context): Promise<compute.ListNodeTypesResponse>;
    private _listZones;
    /**
     * Returns a list of availability zones where clusters can be created in (For
     * example, us-west-2a). These zones can be used to launch a cluster.
     */
    listZones(context?: Context): Promise<compute.ListAvailableZonesResponse>;
     ...
     */
    permanentDelete(request: compute.PermanentDeleteCluster, context?: Context): Promise<EmptyResponse>;
    private _pin;
    /**
     ...
     */
    pin(request: compute.PinCluster, context?: Context): Promise<EmptyResponse>;
    private _resize;
    /**
     * Resizes a cluster to have a desired number of workers. This will fail
     * unless the cluster is in a `RUNNING` state.
     */
    resize(resizeCluster: compute.ResizeCluster, context?: Context): Promise<Waiter<EmptyResponse, compute.ClusterDetails>>;
    private _restart;
    /**
     * Restarts a Spark cluster with the supplied ID. If the cluster is not
     * currently in a `RUNNING` state, nothing will happen.
     */
    restart(restartCluster: compute.RestartCluster, context?: Context): Promise<Waiter<EmptyResponse, compute.ClusterDetails>>;
    private _setPermissions;
    /**
     * Sets permissions on an object, replacing existing permissions if they
     * exist. Deletes all direct permissions if none are specified. Objects can
     * inherit permissions from their root object.
     */
    setPermissions(request: compute.ClusterPermissionsRequest, context?: Context): Promise<compute.ClusterPermissions>;
    private _sparkVersions;
    /**
     * Returns the list of available Spark versions. These versions can be used
     * to launch a cluster.
     */
    sparkVersions(context?: Context): Promise<compute.GetSparkVersionsResponse>;
    private _start;
    /**
     * Starts a terminated Spark cluster with the supplied ID. This works similar
     * to `createCluster` except: - The previous cluster id and attributes are
     ...
     * a job cannot be started.
     */
    start(startCluster: compute.StartCluster, context?: Context): Promise<Waiter<EmptyResponse, compute.ClusterDetails>>;
    private _unpin;
    /**
     ...
     * effect. This API can only be called by workspace admins.
     */
    unpin(request: compute.UnpinCluster, context?: Context): Promise<EmptyResponse>;
    private _update;
    /**
     * Updates the configuration of a cluster to match the partial set of
     * attributes and size. Denote which fields to update using the `update_mask`
     * field in the request body. A cluster can be updated if it is in a
     * `RUNNING` or `TERMINATED` state. If a cluster is updated while in a
     * `RUNNING` state, it will be restarted so that the new attributes can take
     * effect. If a cluster is updated while in a `TERMINATED` state, it will
     * remain `TERMINATED`. The updated attributes will take effect the next time
     * the cluster is started using the `clusters/start` API. Attempts to update
     * a cluster in any other state will be rejected with an `INVALID_STATE`
     * error code. Clusters created by the Databricks Jobs service cannot be
     * updated.
     */
    update(updateCluster: compute.UpdateCluster, context?: Context): Promise<Waiter<EmptyResponse, compute.ClusterDetails>>;
    private _updatePermissions;
    /**
     * Updates the permissions on a cluster. Clusters can inherit permissions
     * from their root object.
     */
    updatePermissions(request: compute.ClusterPermissionsRequest, context?: Context): Promise<compute.ClusterPermissions>;
}
...
export declare class CommandExecutionService {
     ...
     */
    cancel(cancelCommand: compute.CancelCommand, context?: Context): Promise<Waiter<EmptyResponse, compute.CommandStatusResponse>>;
     ...
     * The command ID is obtained from a prior successful call to __execute__.
     */
    commandStatus(request: compute.CommandStatusRequest, context?: Context): Promise<compute.CommandStatusResponse>;
    private _contextStatus;
    /**
     * Gets the status for an execution context.
     */
    contextStatus(request: compute.ContextStatusRequest, context?: Context): Promise<compute.ContextStatusResponse>;
    private _create;
    /**
     ...
     */
    create(createContext: compute.CreateContext, context?: Context): Promise<Waiter<compute.Created, compute.ContextStatusResponse>>;
    private _destroy;
    /**
     * Deletes an execution context.
     */
    destroy(request: compute.DestroyContext, context?: Context): Promise<EmptyResponse>;
    private _execute;
    /**
     ...
     * execution.
     */
    execute(command: compute.Command, context?: Context): Promise<Waiter<compute.Created, compute.CommandStatusResponse>>;
}
...
export declare class GlobalInitScriptsService {
     ...
     */
    create(request: compute.GlobalInitScriptCreateRequest, context?: Context): Promise<compute.CreateResponse>;
    private _delete;
    /**
     * Deletes a global init script.
     */
    delete(request: compute.DeleteGlobalInitScriptRequest, context?: Context): Promise<EmptyResponse>;
    private _get;
    /**
     * Gets all the details of a script, including its Base64-encoded contents.
     */
    get(request: compute.GetGlobalInitScriptRequest, context?: Context): Promise<compute.GlobalInitScriptDetailsWithContent>;
    private _list;
    /**
     ...
     */
    list(context?: Context): AsyncIterable<compute.GlobalInitScriptDetails>;
    private _update;
    /**
     ...
     */
    update(request: compute.GlobalInitScriptUpdateRequest, context?: Context): Promise<EmptyResponse>;
}
...
export declare class InstancePoolsService {
     ...
     */
    create(request: compute.CreateInstancePool, context?: Context): Promise<compute.CreateInstancePoolResponse>;
    private _delete;
    /**
     * Deletes the instance pool permanently. The idle instances in the pool are
     * terminated asynchronously.
     */
    delete(request: compute.DeleteInstancePool, context?: Context): Promise<EmptyResponse>;
    private _edit;
    /**
     * Modifies the configuration of an existing instance pool.
     */
    edit(request: compute.EditInstancePool, context?: Context): Promise<EmptyResponse>;
    private _get;
    /**
     * Retrieve the information for an instance pool based on its identifier.
     */
    get(request: compute.GetInstancePoolRequest, context?: Context): Promise<compute.GetInstancePool>;
    private _getPermissionLevels;
    /**
     * Gets the permission levels that a user can have on an object.
     */
    getPermissionLevels(request: compute.GetInstancePoolPermissionLevelsRequest, context?: Context): Promise<compute.GetInstancePoolPermissionLevelsResponse>;
    private _getPermissions;
    /**
     * Gets the permissions of an instance pool. Instance pools can inherit
     * permissions from their root object.
     */
    getPermissions(request: compute.GetInstancePoolPermissionsRequest, context?: Context): Promise<compute.InstancePoolPermissions>;
    private _list;
    /**
     * Gets a list of instance pools with their statistics.
     */
    list(context?: Context): AsyncIterable<compute.InstancePoolAndStats>;
    private _setPermissions;
    /**
     * Sets permissions on an object, replacing existing permissions if they
     * exist. Deletes all direct permissions if none are specified. Objects can
     * inherit permissions from their root object.
     */
    setPermissions(request: compute.InstancePoolPermissionsRequest, context?: Context): Promise<compute.InstancePoolPermissions>;
    private _updatePermissions;
    /**
     * Updates the permissions on an instance pool. Instance pools can inherit
     * permissions from their root object.
     */
    updatePermissions(request: compute.InstancePoolPermissionsRequest, context?: Context): Promise<compute.InstancePoolPermissions>;
}
...
export declare class InstanceProfilesService {
     ...
     */
    add(request: compute.AddInstanceProfile, context?: Context): Promise<EmptyResponse>;
    private _edit;
    /**
     ...
     */
    edit(request: compute.InstanceProfile, context?: Context): Promise<EmptyResponse>;
    private _list;
    /**
     ...
     */
    list(context?: Context): AsyncIterable<compute.InstanceProfile>;
    private _remove;
    /**
     ...
     */
    remove(request: compute.RemoveInstanceProfile, context?: Context): Promise<EmptyResponse>;
}
export declare class LibrariesRetriableError extends ApiRetriableError {
    constructor(method: string, message?: string);
}
export declare class LibrariesError extends ApiError {
    constructor(method: string, message?: string);
}
/**
...
export declare class LibrariesService {
     ...
     */
    allClusterStatuses(context?: Context): AsyncIterable<compute.ClusterLibraryStatuses>;
    private _clusterStatus;
    /**
     ...
     */
    clusterStatus(request: compute.ClusterStatus, context?: Context): AsyncIterable<compute.LibraryFullStatus>;
    private _install;
    /**
     ...
     */
    install(request: compute.InstallLibraries, context?: Context): Promise<EmptyResponse>;
    private _uninstall;
    /**
     ...
     */
    uninstall(request: compute.UninstallLibraries, context?: Context): Promise<EmptyResponse>;
}
export declare class PolicyComplianceForClustersRetriableError extends ApiRetriableError {
    constructor(method: string, message?: string);
}
export declare class PolicyComplianceForClustersError extends ApiError {
    constructor(method: string, message?: string);
}
/**
 ...
 */
export declare class PolicyComplianceForClustersService {
    readonly client: ApiClient;
    constructor(client: ApiClient);
    private _enforceCompliance;
    /**
     ...
     * enforced by this API. Instead, use the "Enforce job policy compliance" API
     * to enforce policy compliance on jobs.
     */
    enforceCompliance(request: compute.EnforceClusterComplianceRequest, context?: Context): Promise<compute.EnforceClusterComplianceResponse>;
    private _getCompliance;
    /**
     ...
     * edited.
     */
    getCompliance(request: compute.GetClusterComplianceRequest, context?: Context): Promise<compute.GetClusterComplianceResponse>;
    private _listCompliance;
    /**
     ...
     * after the cluster was last edited.
     */
    listCompliance(request: compute.ListClusterCompliancesRequest, context?: Context): AsyncIterable<compute.ClusterCompliance>;
}
...
export declare class PolicyFamiliesService {
     ...
     * version
     */
    get(request: compute.GetPolicyFamilyRequest, context?: Context): Promise<compute.PolicyFamily>;
    private _list;
    /**
     * Returns the list of policy definition types available to use at their
     * latest version. This API is paginated.
     */
    list(request: compute.ListPolicyFamiliesRequest, context?: Context): AsyncIterable<compute.PolicyFamily>;
}
