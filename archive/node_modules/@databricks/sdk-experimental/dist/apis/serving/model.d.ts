import { ReadableStream } from "@databricks/sdk-experimental/src/fetch";
...
export interface AiGatewayConfig {
     ...
     * entities if the request to a served entity fails with certain error codes,
    ...
    /**
     * Configuration for payload logging using inference tables. Use these tables
     * to monitor and audit data being sent to and received from model APIs and
     ...
     */
    rate_limits?: Array<AiGatewayRateLimit>;
    /**
...
export type AiGatewayGuardrailPiiBehaviorBehavior = "BLOCK" | "MASK" | "NONE";
...
export interface AiGatewayInferenceTableConfig {
     ...
     * order to change the catalog name.
     */
    catalog_name?: string;
    /**
...
export type AiGatewayRateLimitKey = "endpoint" | "service_principal" | "user" | "user_group";
export type AiGatewayRateLimitRenewalPeriod = "minute";
...
export interface AmazonBedrockConfig {
     ...
     * API key directly, see `aws_access_key_id_plaintext`. You must provide an
     * API key using one of the following fields: `aws_access_key_id` or
     ...
     * resources. You must authenticate using an instance profile or access keys.
...
export type AmazonBedrockConfigBedrockProvider = "ai21labs" | "amazon" | "anthropic" | "cohere";
...
export interface AutoCaptureConfigOutput {
    /**
     * The name of the catalog in Unity Catalog. NOTE: On update, you cannot
     * change the catalog name if the inference table is already enabled.
     */
...
export interface CohereConfig {
     ...
     * paste your API key directly, see `cohere_api_key_plaintext`. You must
...
export interface DatabricksModelServingConfig {
     ...
     * model serving endpoint pointed to by this external model. If you prefer to
     * paste your API key directly, see `databricks_api_token_plaintext`. You
     * must provide an API key using one of the following fields:
 ...
 * This will always be 'embedding'.
 */
export type EmbeddingsV1ResponseEmbeddingElementObject = "embedding";
export interface EndpointCoreConfigInput {
     ...
     */
    served_entities?: Array<ServedEntityInput>;
    /**
...
export interface EndpointCoreConfigOutput {
     ...
     * The list of served entities under the serving endpoint config.
     */
    served_entities?: Array<ServedEntityOutput>;
    /**
     * (Deprecated, use served_entities instead) The list of served models under
     * the serving endpoint config.
     */
...
export interface EndpointCoreConfigSummary {
     ...
     * The list of served entities under the serving endpoint config.
     */
    served_entities?: Array<ServedEntitySpec>;
    /**
     * (Deprecated, use served_entities instead) The list of served models under
     * the serving endpoint config.
     */
...
export interface EndpointState {
     ...
     * active configuration are ready. If any of the actively served entities are
     * in a non-ready state, the endpoint state will be NOT_READY.
     */
    ready?: EndpointStateReady;
}
export type EndpointStateConfigUpdate = "IN_PROGRESS" | "NOT_UPDATING" | "UPDATE_CANCELED" | "UPDATE_FAILED";
...
export type ExternalFunctionRequestHttpMethod = "DELETE" | "GET" | "PATCH" | "POST" | "PUT";
export interface ExternalModel {
    /**
     * AI21Labs Config. Only required if the provider is 'ai21labs'.
     */
    ai21labs_config?: Ai21LabsConfig;
    /**
...
export type ExternalModelProvider = "ai21labs" | "amazon-bedrock" | "anthropic" | "cohere" | "custom" | "databricks-model-serving" | "google-cloud-vertex-ai" | "openai" | "palm";
...
export interface GetServingEndpointPermissionLevelsRequest {
    /**
     * The serving endpoint for which to get or manage permissions.
     */
    serving_endpoint_id: string;
}
export interface GetServingEndpointPermissionLevelsResponse {
    /**
     * Specific permission levels
     */
    permission_levels?: Array<ServingEndpointPermissionsDescription>;
}
export interface GetServingEndpointPermissionsRequest {
    /**
     * The serving endpoint for which to get or manage permissions.
     */
    serving_endpoint_id: string;
...
export interface GoogleCloudVertexAiConfig {
     ...
     * API key directly, see `private_key_plaintext`. You must provide an API key
     * using one of the following fields: `private_key` or
...
export interface ListServingEndpointsRequest {
}
...
export interface OpenAiConfig {
     ...
     * Entra ID authentication. If you prefer to paste your client secret
     * directly, see `microsoft_entra_client_secret_plaintext`. You must provide
     * an API key using one of the following fields:
...
export interface PatchServingEndpointTags {
    /**
     * List of endpoint tags to add
     */
    add_tags?: Array<EndpointTag>;
    /**
...
export interface PtEndpointCoreConfig {
     ...
     * The list of served entities under the serving endpoint config.
     */
    served_entities?: Array<PtServedModel>;
    traffic_config?: TrafficConfig;
}
export interface PtServedModel {
     ...
     */
    provisioned_model_units: number;
}
export interface PutAiGatewayRequest {
    /**
     * Configuration for traffic fallback which auto fallbacks to other served
     * entities if the request to a served entity fails with certain error codes,
     * to increase availability.
...
export interface PutAiGatewayResponse {
    /**
     * Configuration for traffic fallback which auto fallbacks to other served
     * entities if the request to a served entity fails with certain error codes,
     * to increase availability.
...
export interface QueryEndpointInput {
     ...
     * serving endpoints. This is an array of ChatMessage objects and should only
     * be used with other chat query fields.
     */
    messages?: Array<ChatMessage>;
    /**
     * The n (number of candidates) field used ONLY for __completions__ and
     * __chat external & foundation model__ serving endpoints. This is an integer
     * between 1 and 5 with a default of 1 and should only be used with other
     ...
     * & foundation model__ serving endpoints. This is a list of strings and
...
export interface QueryEndpointResponse {
     ...
     */
    "choices"?: Array<V1ResponseChoiceElement>;
    /**
     ...
     * external/foundation model__ serving endpoint.
     */
    "data"?: Array<EmbeddingsV1ResponseEmbeddingElement>;
    /**
     ...
     */
    "served-model-name"?: string;
    /**
     * The usage object that may be returned by the __external/foundation model__
     * serving endpoint. This contains information about the number of tokens
     * used in the prompt and response.
     */
 ...
 * endpoint, one of [text_completion, chat.completion, list (of embeddings)].
 */
export type QueryEndpointResponseObject = "chat.completion" | "list" | "text_completion";
...
export type RateLimitKey = "endpoint" | "user";
export type RateLimitRenewalPeriod = "minute";
...
export interface ServedEntityInput {
     ...
     * cannot update it to add external_model later. The task type of all
     * external models within an endpoint must be the same.
     */
     ...
     * Valid workload sizes are "Small" (4 - 4 provisioned concurrency), "Medium"
     * (8 - 16 provisioned concurrency), and "Large" (16 - 64 provisioned
     * concurrency). Additional custom workload sizes can also be used when
     * available in the workspace. If scale-to-zero is enabled, the lower bound
     * of the provisioned concurrency for each workload size is 0. Do not use if
     ...
     */
    workload_type?: ServingModelWorkloadType;
}
export interface ServedEntityOutput {
...
export interface ServedEntitySpec {
    entity_name?: string;
    entity_version?: string;
    external_model?: ExternalModel;
    /**
 ...
 */
export type ServedModelInputWorkloadType = "CPU" | "GPU_LARGE" | "GPU_MEDIUM" | "GPU_SMALL" | "MULTIGPU_MEDIUM";
...
export interface ServingEndpointAccessControlRequest {
    /**
     * name of the group
     */
    group_name?: string;
...
export interface ServingEndpointAccessControlResponse {
    /**
     * All permissions.
     */
    all_permissions?: Array<ServingEndpointPermission>;
    /**
...
export interface ServingEndpointDetailed {
     ...
     */
    data_plane_info?: ModelDataPlaneInfo;
    /**
...
export interface ServingEndpointPermission {
    inherited?: boolean;
 ...
 * Permission level
 */
export type ServingEndpointPermissionLevel = "CAN_MANAGE" | "CAN_QUERY" | "CAN_VIEW";
export interface ServingEndpointPermissions {
    access_control_list?: Array<ServingEndpointAccessControlResponse>;
    object_id?: string;
    object_type?: string;
}
export interface ServingEndpointPermissionsDescription {
    description?: string;
    /**
     * Permission level
     */
...
export interface ServingEndpointPermissionsRequest {
    access_control_list?: Array<ServingEndpointAccessControlRequest>;
    /**
     * The serving endpoint for which to get or manage permissions.
     */
    serving_endpoint_id: string;
 ...
 * InferenceEndpointEntities.scala
 */
export type ServingModelWorkloadType = "CPU" | "GPU_LARGE" | "GPU_MEDIUM" | "GPU_SMALL" | "MULTIGPU_MEDIUM";
...
export interface UpdateProvisionedThroughputEndpointConfigRequest {
    config: PtEndpointCoreConfig;
    /**
