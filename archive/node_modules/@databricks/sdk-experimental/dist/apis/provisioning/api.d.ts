...
import * as provisioning from "@databricks/sdk-experimental/src/apis/provisioning/model";
...
export declare class CredentialsService {
     ...
     */
    create(request: provisioning.CreateCredentialRequest, context?: Context): Promise<provisioning.Credential>;
    private _delete;
    /**
     ...
     * any workspace.
     */
    delete(request: provisioning.DeleteCredentialRequest, context?: Context): Promise<provisioning.Credential>;
    private _get;
    /**
     * Gets a Databricks credential configuration object for an account, both
     * specified by ID.
     */
    get(request: provisioning.GetCredentialRequest, context?: Context): Promise<provisioning.Credential>;
    private _list;
    /**
     * List Databricks credential configuration objects for an account, specified
     * by ID.
     */
    list(context?: Context): Promise<Array<provisioning.Credential>>;
}
...
export declare class EncryptionKeysService {
     ...
     * per account.
     */
    create(request: provisioning.CreateCustomerManagedKeyRequest, context?: Context): Promise<provisioning.CustomerManagedKey>;
    private _delete;
    /**
     ...
     */
    delete(request: provisioning.DeleteEncryptionKeyRequest, context?: Context): Promise<provisioning.CustomerManagedKey>;
    private _get;
    /**
     ...
     * the platform.",
     */
    get(request: provisioning.GetEncryptionKeyRequest, context?: Context): Promise<provisioning.CustomerManagedKey>;
    private _list;
    /**
     * Lists Databricks customer-managed key configurations for an account.
     */
    list(context?: Context): Promise<Array<provisioning.CustomerManagedKey>>;
}
...
export declare class NetworksService {
     ...
     */
    create(request: provisioning.CreateNetworkRequest, context?: Context): Promise<provisioning.Network>;
    private _delete;
    /**
     ...
     * the platform.
     */
    delete(request: provisioning.DeleteNetworkRequest, context?: Context): Promise<provisioning.Network>;
    private _get;
    /**
     * Gets a Databricks network configuration, which represents a cloud VPC and
     * its resources.
     */
    get(request: provisioning.GetNetworkRequest, context?: Context): Promise<provisioning.Network>;
    private _list;
    /**
     * Lists Databricks network configurations for an account.
     */
    list(context?: Context): Promise<Array<provisioning.Network>>;
}
...
export declare class PrivateAccessService {
     ...
     */
    create(request: provisioning.CreatePrivateAccessSettingsRequest, context?: Context): Promise<provisioning.PrivateAccessSettings>;
    private _delete;
    /**
     * Deletes a Databricks private access settings configuration, both specified
     * by ID.
     */
    delete(request: provisioning.DeletePrivateAccesRequest, context?: Context): Promise<provisioning.PrivateAccessSettings>;
    private _get;
    /**
     * Gets a Databricks private access settings configuration, both specified by
     * ID.
     */
    get(request: provisioning.GetPrivateAccesRequest, context?: Context): Promise<provisioning.PrivateAccessSettings>;
    private _list;
    /**
     * Lists Databricks private access settings for an account.
     */
    list(context?: Context): Promise<Array<provisioning.PrivateAccessSettings>>;
    private _replace;
    /**
     ...
     */
    replace(request: provisioning.ReplacePrivateAccessSettingsRequest, context?: Context): Promise<provisioning.PrivateAccessSettings>;
}
...
export declare class StorageService {
     ...
     */
    create(request: provisioning.CreateStorageConfigurationRequest, context?: Context): Promise<provisioning.StorageConfiguration>;
    private _delete;
    /**
     * Deletes a Databricks storage configuration. You cannot delete a storage
     * configuration that is associated with any workspace.
     */
    delete(request: provisioning.DeleteStorageRequest, context?: Context): Promise<provisioning.StorageConfiguration>;
    private _get;
    /**
     * Gets a Databricks storage configuration for an account, both specified by
     * ID.
     */
    get(request: provisioning.GetStorageRequest, context?: Context): Promise<provisioning.StorageConfiguration>;
    private _list;
    /**
     * Lists Databricks storage configurations for an account, specified by ID.
     */
    list(context?: Context): Promise<Array<provisioning.StorageConfiguration>>;
}
...
export declare class VpcEndpointsService {
     ...
     */
    create(request: provisioning.CreateVpcEndpointRequest, context?: Context): Promise<provisioning.VpcEndpoint>;
    private _delete;
    /**
     ...
     */
    delete(request: provisioning.DeleteVpcEndpointRequest, context?: Context): Promise<provisioning.VpcEndpoint>;
    private _get;
    /**
     ...
     */
    get(request: provisioning.GetVpcEndpointRequest, context?: Context): Promise<provisioning.VpcEndpoint>;
    private _list;
    /**
     * Lists Databricks VPC endpoint configurations for an account.
     */
    list(context?: Context): Promise<Array<provisioning.VpcEndpoint>>;
}
...
export declare class WorkspacesService {
     ...
     * [Create a new workspace using the Account API]: http://docs.databricks.com/administration-guide/account-api/new-workspace.html
     */
    create(createWorkspaceRequest: provisioning.CreateWorkspaceRequest, context?: Context): Promise<Waiter<provisioning.Workspace, provisioning.Workspace>>;
    private _delete;
    /**
     * Deletes a Databricks workspace, both specified by ID.
     */
    delete(request: provisioning.DeleteWorkspaceRequest, context?: Context): Promise<provisioning.Workspace>;
    private _get;
    /**
     ...
     * [Create a new workspace using the Account API]: http://docs.databricks.com/administration-guide/account-api/new-workspace.html
     */
    get(request: provisioning.GetWorkspaceRequest, context?: Context): Promise<provisioning.Workspace>;
    private _list;
    /**
     * Lists Databricks workspaces for an account.
     */
    list(context?: Context): Promise<Array<provisioning.Workspace>>;
    private _update;
    /**
     * Updates a workspace.
     */
    update(updateWorkspaceRequest: provisioning.UpdateWorkspaceRequest, context?: Context): Promise<Waiter<provisioning.Workspace, provisioning.Workspace>>;
}
