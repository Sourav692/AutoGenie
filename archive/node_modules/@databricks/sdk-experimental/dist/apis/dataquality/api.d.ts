...
import * as dataquality from "@databricks/sdk-experimental/src/apis/dataquality/model";
...
export declare class DataQualityService {
     ...
     * **MANAGE** on the table.
     */
    cancelRefresh(request: dataquality.CancelRefreshRequest, context?: Context): Promise<dataquality.CancelRefreshResponse>;
    private _createMonitor;
    /**
     ...
     * **MANAGE** and **USE_SCHEMA** on the table's parent schema, and **SELECT**
     * on the table. 3. **USE_CATALOG** on the table's parent catalog,
     * **USE_SCHEMA** on the table's parent schema, and **MANAGE** and **SELECT**
     * on the table.
     *
     ...
     */
    createMonitor(request: dataquality.CreateMonitorRequest, context?: Context): Promise<dataquality.Monitor>;
    private _createRefresh;
    /**
     * Creates a refresh. Currently only supported for the `table` `object_type`.
     * The call must be made in the same workspace as where the monitor was
     * created.
     *
     * The caller must have either of the following sets of permissions: 1.
     * **MANAGE** and **USE_CATALOG** on the table's parent catalog. 2.
     ...
     * **MANAGE** on the table.
     */
    createRefresh(request: dataquality.CreateRefreshRequest, context?: Context): Promise<dataquality.Refresh>;
    private _deleteMonitor;
    /**
     * Delete a data quality monitor on Unity Catalog object.
     *
     * For the `table` `object_type`, the caller must have either of the
     * following sets of permissions: **MANAGE** and **USE_CATALOG** on the
     * table's parent catalog. **USE_CATALOG** on the table's parent catalog, and
     * **MANAGE** and **USE_SCHEMA** on the table's parent schema.
     ...
     * catalog, and **MANAGE** and **USE_SCHEMA** on the schema.
     */
    deleteMonitor(request: dataquality.DeleteMonitorRequest, context?: Context): Promise<EmptyResponse>;
    private _deleteRefresh;
    /**
     * (Unimplemented) Delete a refresh
     */
    deleteRefresh(request: dataquality.DeleteRefreshRequest, context?: Context): Promise<EmptyResponse>;
    private _getMonitor;
    /**
     ...
     */
    getMonitor(request: dataquality.GetMonitorRequest, context?: Context): Promise<dataquality.Monitor>;
    private _getRefresh;
    /**
     ...
     * catalog, and **USE_SCHEMA** on the schema.
     */
    getRefresh(request: dataquality.GetRefreshRequest, context?: Context): Promise<dataquality.Refresh>;
    private _listMonitor;
    /**
     * (Unimplemented) List data quality monitors.
     */
    listMonitor(request: dataquality.ListMonitorRequest, context?: Context): AsyncIterable<dataquality.Monitor>;
     ...
     * catalog, and **USE_SCHEMA** on the schema.
     */
    listRefresh(request: dataquality.ListRefreshRequest, context?: Context): AsyncIterable<dataquality.Refresh>;
    private _updateMonitor;
    /**
     ...
     * catalog, and **MANAGE** and **USE_SCHEMA** on the schema.
     */
    updateMonitor(request: dataquality.UpdateMonitorRequest, context?: Context): Promise<dataquality.Monitor>;
    private _updateRefresh;
    /**
     * (Unimplemented) Update a refresh
     */
    updateRefresh(request: dataquality.UpdateRefreshRequest, context?: Context): Promise<dataquality.Refresh>;
}
