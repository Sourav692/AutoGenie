<!doctype html>
<html lang="en" dir="ltr" class="docs-wrapper plugin-docs plugin-id-default docs-version-current docs-doc-page docs-doc-id-api/appkit/Interface.ResourceEntry" data-has-hydrated="false">
<head>
<meta charset="UTF-8">
...
<ul>
<li class=""><a class="" href="/appkit/docs/api/appkit/Interface.ResourceRequirement"><code>ResourceRequirement</code></a></li>
</ul>
...
<p><a class="" href="/appkit/docs/api/appkit/Interface.ResourceRequirement"><code>ResourceRequirement</code></a>.<a class="" href="/appkit/docs/api/appkit/Interface.ResourceRequirement#alias"><code>alias</code></a></p>
<hr>
...
<p><a class="" href="/appkit/docs/api/appkit/Interface.ResourceRequirement"><code>ResourceRequirement</code></a>.<a class="" href="/appkit/docs/api/appkit/Interface.ResourceRequirement#description"><code>description</code></a></p>
<hr>
...
<p><a class="" href="/appkit/docs/api/appkit/Interface.ResourceRequirement"><code>ResourceRequirement</code></a>.<a class="" href="/appkit/docs/api/appkit/Interface.ResourceRequirement#fields"><code>fields</code></a></p>
<hr>
...
<p><a class="" href="/appkit/docs/api/appkit/Interface.ResourceRequirement"><code>ResourceRequirement</code></a>.<a class="" href="/appkit/docs/api/appkit/Interface.ResourceRequirement#permission"><code>permission</code></a></p>
<hr>
<h3 class="anchor anchorTargetStickyNavbar_scV4" id="permissionsources">permissionSources?<a href="#permissionsources" class="hash-link" aria-label="Direct link to permissionSources?" title="Direct link to permissionSources?" translate="no">​</a></h3>
<div class="language-ts codeBlockContainer_crgn theme-code-block" style="--prism-color:#000000;--prism-background-color:#ffffff"><div class="codeBlockContent__42J"><pre tabindex="0" class="prism-code language-ts codeBlock_CnLD thin-scrollbar" style="color:#000000;background-color:#ffffff"><code class="codeBlockLines_sJEA"><span class="token-line" style="color:#000000"><span class="token plain">optional permissionSources</span><span class="token operator" style="color:rgb(0, 0, 0)">:</span><span class="token plain"> Record</span><span class="token operator" style="color:rgb(0, 0, 0)">&lt;</span><span class="token builtin" style="color:rgb(0, 112, 193)">string</span><span class="token punctuation" style="color:rgb(4, 81, 165)">,</span><span class="token plain"> ResourcePermission</span><span class="token operator" style="color:rgb(0, 0, 0)">&gt;</span><span class="token punctuation" style="color:rgb(4, 81, 165)">;</span><br></span></code></pre></div></div>
<p>Per-plugin permission tracking.
Maps plugin name to the permission it originally requested.
Populated when multiple plugins share the same resource.</p>
<hr>
<h3 class="anchor anchorTargetStickyNavbar_scV4" id="plugin">plugin<a href="#plugin" class="hash-link" aria-label="Direct link to plugin" title="Direct link to plugin" translate="no">​</a></h3>
<div class="language-ts codeBlockContainer_crgn theme-code-block" style="--prism-color:#000000;--prism-background-color:#ffffff"><div class="codeBlockContent__42J"><pre tabindex="0" class="prism-code language-ts codeBlock_CnLD thin-scrollbar" style="color:#000000;background-color:#ffffff"><code class="codeBlockLines_sJEA"><span class="token-line" style="color:#000000"><span class="token plain">plugin</span><span class="token operator" style="color:rgb(0, 0, 0)">:</span><span class="token plain"> </span><span class="token builtin" style="color:rgb(0, 112, 193)">string</span><span class="token punctuation" style="color:rgb(4, 81, 165)">;</span><br></span></code></pre></div></div>
<p>Plugin(s) that require this resource (comma-separated if multiple)</p>
<hr>
...
<p><a class="" href="/appkit/docs/api/appkit/Interface.ResourceRequirement"><code>ResourceRequirement</code></a>.<a class="" href="/appkit/docs/api/appkit/Interface.ResourceRequirement#required"><code>required</code></a></p>
<hr>
<h3 class="anchor anchorTargetStickyNavbar_scV4" id="resolved">resolved<a href="#resolved" class="hash-link" aria-label="Direct link to resolved" title="Direct link to resolved" translate="no">​</a></h3>
<div class="language-ts codeBlockContainer_crgn theme-code-block" style="--prism-color:#000000;--prism-background-color:#ffffff"><div class="codeBlockContent__42J"><pre tabindex="0" class="prism-code language-ts codeBlock_CnLD thin-scrollbar" style="color:#000000;background-color:#ffffff"><code class="codeBlockLines_sJEA"><span class="token-line" style="color:#000000"><span class="token plain">resolved</span><span class="token operator" style="color:rgb(0, 0, 0)">:</span><span class="token plain"> </span><span class="token builtin" style="color:rgb(0, 112, 193)">boolean</span><span class="token punctuation" style="color:rgb(4, 81, 165)">;</span><br></span></code></pre></div></div>
<p>Whether the resource has been resolved (all field env vars set)</p>
<hr>
...
<h4 class="anchor anchorTargetStickyNavbar_scV4" id="inherited-from-5">Inherited from<a href="#inherited-from-5" class="hash-link" aria-label="Direct link to Inherited from" title="Direct link to Inherited from" translate="no">​</a></h4>
<p><a class="" href="/appkit/docs/api/appkit/Interface.ResourceRequirement"><code>ResourceRequirement</code></a>.<a class="" href="/appkit/docs/api/appkit/Interface.ResourceRequirement#resourcekey"><code>resourceKey</code></a></p>
<hr>
...
<p>Type of Databricks resource required</p>
<h4 class="anchor anchorTargetStickyNavbar_scV4" id="inherited-from-6">Inherited from<a href="#inherited-from-6" class="hash-link" aria-label="Direct link to Inherited from" title="Direct link to Inherited from" translate="no">​</a></h4>
<p><a class="" href="/appkit/docs/api/appkit/Interface.ResourceRequirement"><code>ResourceRequirement</code></a>.<a class="" href="/appkit/docs/api/appkit/Interface.ResourceRequirement#type"><code>type</code></a></p>
<hr>
<h3 class="anchor anchorTargetStickyNavbar_scV4" id="values">values?<a href="#values" class="hash-link" aria-label="Direct link to values?" title="Direct link to values?" translate="no">​</a></h3>
<div class="language-ts codeBlockContainer_crgn theme-code-block" style="--prism-color:#000000;--prism-background-color:#ffffff"><div class="codeBlockContent__42J"><pre tabindex="0" class="prism-code language-ts codeBlock_CnLD thin-scrollbar" style="color:#000000;background-color:#ffffff"><code class="codeBlockLines_sJEA"><span class="token-line" style="color:#000000"><span class="token plain">optional values</span><span class="token operator" style="color:rgb(0, 0, 0)">:</span><span class="token plain"> Record</span><span class="token operator" style="color:rgb(0, 0, 0)">&lt;</span><span class="token builtin" style="color:rgb(0, 112, 193)">string</span><span class="token punctuation" style="color:rgb(4, 81, 165)">,</span><span class="token plain"> </span><span class="token builtin" style="color:rgb(0, 112, 193)">string</span><span class="token operator" style="color:rgb(0, 0, 0)">&gt;</span><span class="token punctuation" style="color:rgb(4, 81, 165)">;</span><br></span></code></pre></div></div>
<p>Resolved value per field name. Populated by validate() when all field env vars are set.</p></div><footer class="theme-doc-footer docusaurus-mt-lg"><div class="row margin-top--sm theme-doc-footer-edit-meta-row"><div class="col noPrint_Z6Q_"><a href="https://github.com/databricks/appkit/edit/main/docs/docs/api/appkit/Interface.ResourceEntry.md" target="_blank" rel="noopener noreferrer" class="theme-edit-this-page"><svg fill="currentColor" height="20" width="20" viewBox="0 0 40 40" class="iconEdit_kMm5" aria-hidden="true"><g><path d="m34.5 11.7l-3 3.1-6.3-6.3 3.1-3q0.5-0.5 1.2-0.5t1.1 0.5l3.9 3.9q0.5 0.4 0.5 1.1t-0.5 1.2z m-29.5 17.1l18.4-18.5 6.3 6.3-18.4 18.4h-6.3v-6.2z"></path></g></svg>Edit this page</a></div><div class="col lastUpdated_mnLK"></div></div></footer></article><nav class="docusaurus-mt-lg pagination-nav" aria-label="Docs pages"><a class="pagination-nav__link pagination-nav__link--prev" href="/appkit/docs/api/appkit/Interface.RequestedResource"><div class="pagination-nav__sublabel">Previous</div><div class="pagination-nav__label">RequestedResource</div></a><a class="pagination-nav__link pagination-nav__link--next" href="/appkit/docs/api/appkit/Interface.ResourceFieldEntry"><div class="pagination-nav__sublabel">Next</div><div class="pagination-nav__label">ResourceFieldEntry</div></a></nav></div></div><div class="col col--3"><div class="tableOfContents_xfIk thin-scrollbar theme-doc-toc-desktop"><ul class="table-of-contents table-of-contents__left-border"><li><a href="#extends" class="table-of-contents__link toc-highlight">Extends</a></li><li><a href="#properties" class="table-of-contents__link toc-highlight">Properties</a><ul><li><a href="#alias" class="table-of-contents__link toc-highlight">alias</a></li><li><a href="#description" class="table-of-contents__link toc-highlight">description</a></li><li><a href="#fields" class="table-of-contents__link toc-highlight">fields</a></li><li><a href="#permission" class="table-of-contents__link toc-highlight">permission</a></li><li><a href="#permissionsources" class="table-of-contents__link toc-highlight">permissionSources?</a></li><li><a href="#plugin" class="table-of-contents__link toc-highlight">plugin</a></li><li><a href="#required" class="table-of-contents__link toc-highlight">required</a></li><li><a href="#resolved" class="table-of-contents__link toc-highlight">resolved</a></li><li><a href="#resourcekey" class="table-of-contents__link toc-highlight">resourceKey</a></li><li><a href="#type" class="table-of-contents__link toc-highlight">type</a></li><li><a href="#values" class="table-of-contents__link toc-highlight">values?</a></li></ul></li></ul></div></div></div></div></main></div></div></div><footer class="theme-layout-footer footer footer--dark"><div class="container container-fluid"><div class="row footer__links"><div class="theme-layout-footer-column col footer__col"><div class="footer__title">Docs</div><ul class="footer__items clean-list"><li class="footer__item"><a class="footer__link-item" href="/appkit/docs/">Getting started</a></li><li class="footer__item"><a class="footer__link-item" href="/appkit/docs/api/">API reference</a></li></ul></div><div class="theme-layout-footer-column col footer__col"><div class="footer__title">Community</div><ul class="footer__items clean-list"><li class="footer__item"><a class="footer__link-item" href="/appkit/contributing">Contributing</a></li><li class="footer__item"><a href="https://github.com/databricks/appkit" target="_blank" rel="noopener noreferrer" class="footer__link-item">GitHub<svg width="13.5" height="13.5" aria-label="(opens in new tab)" class="iconExternalLink_miaU"><use href="#theme-svg-external-link"></use></svg></a></li></ul></div><div class="theme-layout-footer-column col footer__col"><div class="footer__title">More</div><ul class="footer__items clean-list"><li class="footer__item"><a href="https://docs.databricks.com/aws/en/dev-tools/databricks-apps/" target="_blank" rel="noopener noreferrer" class="footer__link-item">Databricks Apps docs<svg width="13.5" height="13.5" aria-label="(opens in new tab)" class="iconExternalLink_miaU"><use href="#theme-svg-external-link"></use></svg></a></li><li class="footer__item"><a href="https://github.com/databricks/cli" target="_blank" rel="noopener noreferrer" class="footer__link-item">Databricks CLI<svg width="13.5" height="13.5" aria-label="(opens in new tab)" class="iconExternalLink_miaU"><use href="#theme-svg-external-link"></use></svg></a></li></ul></div></div><div class="footer__bottom text--center"><div class="footer__copyright">Copyright © 2026 Databricks, Inc.</div></div></div></footer></div>
</body>
</html>