<!doctype html>
<html lang="en" dir="ltr" class="docs-wrapper plugin-docs plugin-id-default docs-version-current docs-doc-page docs-doc-id-api/appkit/Interface.RequestedClaims" data-has-hydrated="false">
<head>
<meta charset="UTF-8">
...
<h3 class="anchor anchorTargetStickyNavbar_scV4" id="permission_set">permission_set?<a href="#permission_set" class="hash-link" aria-label="Direct link to permission_set?" title="Direct link to permission_set?" translate="no">​</a></h3>
<div class="language-ts codeBlockContainer_crgn theme-code-block" style="--prism-color:#000000;--prism-background-color:#ffffff"><div class="codeBlockContent__42J"><pre tabindex="0" class="prism-code language-ts codeBlock_CnLD thin-scrollbar" style="color:#000000;background-color:#ffffff"><code class="codeBlockLines_sJEA"><span class="token-line" style="color:#000000"><span class="token plain">optional permission_set</span><span class="token operator" style="color:rgb(0, 0, 0)">:</span><span class="token plain"> </span><span class="token constant" style="color:rgb(129, 31, 63)">READ_ONLY</span><span class="token punctuation" style="color:rgb(4, 81, 165)">;</span><br></span></code></pre></div></div>
<p>Permission level to request</p>
<hr>
