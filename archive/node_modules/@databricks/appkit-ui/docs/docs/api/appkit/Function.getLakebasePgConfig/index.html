<!doctype html>
<html lang="en" dir="ltr" class="docs-wrapper plugin-docs plugin-id-default docs-version-current docs-doc-page docs-doc-id-api/appkit/Function.getLakebasePgConfig" data-has-hydrated="false">
<head>
<meta charset="UTF-8">
...
<table><thead><tr><th>Parameter</th><th>Type</th><th>Description</th></tr></thead><tbody><tr><td><code>config?</code></td><td><code>Partial</code>&lt;<a class="" href="/appkit/docs/api/appkit/Interface.LakebasePoolConfig"><code>LakebasePoolConfig</code></a>&gt;</td><td>Optional configuration (reads from environment if not provided)</td></tr><tr><td><code>telemetry?</code></td><td><code>DriverTelemetry</code></td><td>Optional pre-initialized telemetry (created internally if not provided)</td></tr><tr><td><code>logger?</code></td><td><code>Logger</code></td><td>Optional logger (silent if not provided)</td></tr></tbody></table>
