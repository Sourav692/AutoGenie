<!doctype html>
<html lang="en" dir="ltr" class="docs-wrapper plugin-docs plugin-id-default docs-version-current docs-doc-page docs-doc-id-api/appkit/Function.getPluginManifest" data-has-hydrated="false">
<head>
<meta charset="UTF-8">
...
<p><a class="" href="/appkit/docs/api/appkit/Interface.PluginManifest"><code>PluginManifest</code></a></p>
<p>The validated, normalized plugin manifest</p>
