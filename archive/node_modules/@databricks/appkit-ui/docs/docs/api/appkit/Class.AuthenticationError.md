...
### credentialsFailed()[​](#credentialsfailed "Direct link to credentialsFailed()")
...
### missingToken()[​](#missingtoken "Direct link to missingToken()")
...
### missingUserId()[​](#missinguserid "Direct link to missingUserId()")
...
### userLookupFailed()[​](#userlookupfailed "Direct link to userLookupFailed()")
